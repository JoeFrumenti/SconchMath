...
int main()
{
    ...
    unsigned char* data = stbi_load("C:/Users/joefr/source/include/Textures/container.jpg", & width, & height, & nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("C:/Users/joefr/source/include/Textures/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
